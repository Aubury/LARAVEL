<template>
    <div>
        <form v-on:submit="submitFile" :id="id">
            ...
            <input type="hidden" name="product_id" ref="product_id" :value="product_id">
            <div class="example-1">
                <div class="form-group">
                    <label class="label_input-file">
                        <i class="material-icons">attach_file</i>
                        <span class="title" data-multiple-caption="Вы выбрали {count} файла!">Изменить файл</span>
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.data = JSON.parse(this.product);
        ...
        methods: {
            ...
            handleFileUpload() {
                ...
                this.formData.append('product_id', this.$refs.product_id.value);
                this.error = false;
            },
            submitFile(e) {
                e.preventDefault();
